...
Source0  : https://files.pythonhosted.org/packages/53/98/a4ed0243a90fd1c654fb8b39345f49d25470149ab60f80867ff7367de5f2/diffoscope-259.tar.gz
...
%prep
%setup -q -n diffoscope-259
cd %{_builddir}/diffoscope-259
pushd ..
cp -a diffoscope-259 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709324249
