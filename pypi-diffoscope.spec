...
Source0  : https://files.pythonhosted.org/packages/52/f8/e1f87234316315f87ed3c3d767d79d6fd6d512a7037a7087b50b111a2b45/diffoscope-254.tar.gz
...
%prep
%setup -q -n diffoscope-254
cd %{_builddir}/diffoscope-254
pushd ..
cp -a diffoscope-254 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705701827
