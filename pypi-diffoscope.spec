...
Source0  : https://files.pythonhosted.org/packages/21/fb/425f842a8066fef249aa46fe1e42dc1e750ffccbc54b147048497aca7710/diffoscope-284.tar.gz
...
%prep
%setup -q -n diffoscope-284
cd %{_builddir}/diffoscope-284
pushd ..
cp -a diffoscope-284 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733583170
