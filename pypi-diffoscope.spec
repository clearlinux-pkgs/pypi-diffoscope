...
Source0  : https://files.pythonhosted.org/packages/f5/06/8c62b445179161c05cd0622b06b7deae84fde49221668931b1de735bff4b/diffoscope-264.tar.gz
...
%prep
%setup -q -n diffoscope-264
cd %{_builddir}/diffoscope-264
pushd ..
cp -a diffoscope-264 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712936266
