...
Source0  : https://files.pythonhosted.org/packages/b0/ab/1c5cc184a859ab7c21efbcc7a0d6396a7e0be4d36c1615d76865ec9aadb7/diffoscope-252.tar.gz
...
%prep
%setup -q -n diffoscope-252
cd %{_builddir}/diffoscope-252
pushd ..
cp -a diffoscope-252 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700239193
