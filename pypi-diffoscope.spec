...
Source0  : https://files.pythonhosted.org/packages/dd/da/208187b9a1df4a01f1d64aacdc353a07a8304b3b2cf7689938db5c191d35/diffoscope-296.tar.gz
...
%prep
%setup -q -n diffoscope-296
cd %{_builddir}/diffoscope-296
pushd ..
cp -a diffoscope-296 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747417918
