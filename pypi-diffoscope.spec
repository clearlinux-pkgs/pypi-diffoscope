...
Source0  : https://files.pythonhosted.org/packages/29/48/7ce3bb2998b6b04a6167e35753c5a6eb089c1f8f2d4602152ee014e859a7/diffoscope-255.tar.gz
...
%prep
%setup -q -n diffoscope-255
cd %{_builddir}/diffoscope-255
pushd ..
cp -a diffoscope-255 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706306624
