...
Source0  : https://files.pythonhosted.org/packages/e6/04/4a9df77e0b0dea2bd70b7366d9751237cc79ae2598d6dfbe5e5ab57f6228/diffoscope-295.tar.gz
...
%prep
%setup -q -n diffoscope-295
cd %{_builddir}/diffoscope-295
pushd ..
cp -a diffoscope-295 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747067040
