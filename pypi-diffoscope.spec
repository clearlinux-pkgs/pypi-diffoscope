...
Source0  : https://files.pythonhosted.org/packages/0a/48/96d106a6b6bc567da8fdf43a6949aef1c90932a526193031c96c8fd786b9/diffoscope-293.tar.gz
...
%prep
%setup -q -n diffoscope-293
cd %{_builddir}/diffoscope-293
pushd ..
cp -a diffoscope-293 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743429997
