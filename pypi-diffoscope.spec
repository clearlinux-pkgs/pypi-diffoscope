...
Source0  : https://files.pythonhosted.org/packages/1d/27/44077444f88a0bfe6129bf48041f55ad837735a7fa0b7f1847361c094d5f/diffoscope-272.tar.gz
...
%prep
%setup -q -n diffoscope-272
cd %{_builddir}/diffoscope-272
pushd ..
cp -a diffoscope-272 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720479282
