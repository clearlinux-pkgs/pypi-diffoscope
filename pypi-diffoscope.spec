...
Source0  : https://files.pythonhosted.org/packages/fa/b1/dbd4705b185bd29ba52af49fb043409e57791d6e7912ef549caf668cd96f/diffoscope-285.tar.gz
...
%prep
%setup -q -n diffoscope-285
cd %{_builddir}/diffoscope-285
pushd ..
cp -a diffoscope-285 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737482358
