...
Source0  : https://files.pythonhosted.org/packages/e5/92/5d4b06ebe9c9bd30ccf0c462c1c87825ecc8dfb7e50057bd98cb3e1dda6b/diffoscope-251.tar.gz
...
%prep
%setup -q -n diffoscope-251
cd %{_builddir}/diffoscope-251
pushd ..
cp -a diffoscope-251 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699284752
