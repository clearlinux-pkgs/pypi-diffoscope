...
Source0  : https://files.pythonhosted.org/packages/6b/6b/c9ccbef5d686a8bca94cd02415619c859fc09e793e6e15131d8423a8b892/diffoscope-283.tar.gz
...
%prep
%setup -q -n diffoscope-283
cd %{_builddir}/diffoscope-283
pushd ..
cp -a diffoscope-283 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731441074
