...
Source0  : https://files.pythonhosted.org/packages/51/49/eb7545893027dda1767858b39305c9048a0d9636804616d79a8dc906f2fb/diffoscope-294.tar.gz
...
%prep
%setup -q -n diffoscope-294
cd %{_builddir}/diffoscope-294
pushd ..
cp -a diffoscope-294 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744413757
