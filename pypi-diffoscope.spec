...
Source0  : https://files.pythonhosted.org/packages/4b/1a/02922061a5e5ea718fe1a63b1b7a8f932a8420b914904ca5b5987369f926/diffoscope-263.tar.gz
...
%prep
%setup -q -n diffoscope-263
cd %{_builddir}/diffoscope-263
pushd ..
cp -a diffoscope-263 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712325992
