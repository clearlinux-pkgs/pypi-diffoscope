...
Source0  : https://files.pythonhosted.org/packages/cf/32/6c395049e7a7c8c50fef66fa5a83f1b3730034f01d227647d731e95fedf5/diffoscope-273.tar.gz
...
%prep
%setup -q -n diffoscope-273
cd %{_builddir}/diffoscope-273
pushd ..
cp -a diffoscope-273 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722441022
